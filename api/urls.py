...
from .views import ProfileDetailView, ProfileExportView, ProfileSearchView, ProfileUploadView, ProfileView
...
urlpatterns = [
    ...
    path("profiles/upload/", ProfileUploadView.as_view(), name="profiles-upload"),
